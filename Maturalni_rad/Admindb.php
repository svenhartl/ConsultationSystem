...
<form class="form" method="get" action="/Maturalni_rad/userlist.php">
    <button type="submit" class="bn3">Popis korisnika</button>
</form>

<form class="form" method="get" action="/Maturalni_rad/proflist.php">
    <button type="submit" class="bn3">Popis nastavnika i termina</button>
</form>
</body>
</html>